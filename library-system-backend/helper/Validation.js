...
const password = body("password")
  ...
  .withMessage("Must be 8 minimum & maximum 15 characters.");
...
const phone = body("phone")
  ...
  .withMessage("is minimum 11 number and maximum 11 to 13")
  .matches(/^(09|\+639)\d{9}$/)
  .withMessage("invalid format. ex: 09/+639");
...
const password2 = body("password")
  .trim()
  .isLength({ min: 8, max: 15 })
  .withMessage("must be minimum 8 & maximum 15 characters.")
  .optional({ nullable: true, checkFalsy: true });
const password3 = body("password")
  .notEmpty()
  .trim()
  .isLength({ min: 8, max: 15 })
  .withMessage("Must be 8 minimum & maximum 15 characters.");
...
const registerNewUserValidation = [
  firstname,
  lastname,
  middlename,
  phone,
